...
// Updated callback signature for newer ESP-NOW API
...
void updateDisplay() {
  ...
  displayPtr->print("Last Tx: ");
  displayPtr->println(lastTransmitStatus);
  ...
  displayPtr->print("% ");
  displayPtr->print(deviceReadings[deviceIndex].pressure, 1);
  displayPtr->println("hPa");
